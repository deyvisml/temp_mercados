...
<script type="text/javascript">
    $("#vregbolpag_mensual_buscar").click(function() {
        loading("open");
        $.post("<?php echo site_url("modulo2/get_datos_bpmensual"); ?>", $("#vregbolpag_mensual_form_buscar").serialize(), function(data) {
            if (data == "error") {
                $("#vregbolpag_mensual_result").html("<h1>LA BOLETA YA FUE REGISTRADA O NO EXISTE O NO ES UNA BOLETA DE PAGO MENSUAL</h1>");
            } else {
                $("#vregbolpag_mensual_result").html(data);
                $("#vregbolpag_mensual_busqueda_x_cpn").css("display", "none");
                $("#vregbolpag_mensual_div_registrar").css("display", "block");
    ...
    $("#vregbolpag_mensual_form_buscar").submit(function(e) {
        e.preventDefault();
        loading("open");
        $.post("<?php echo site_url("modulo2/guardar_boleta_meses"); ?>", $(this).serialize(), function(data) {
            loading("close");
            notify(data);
            alert(data);
...
<div class="card">
    <div class="card-header">
        <h2>Registrar Boleta de Pago Mensuales</h2>
    </div>
    <div class="card-body card-padding">
        <form id="vregbolpag_mensual_form_buscar">
            <div class="row" id="vregbolpag_mensual_busqueda_x_cpn">
                <div class="col-sm-3">
                ...
                <div class="col-sm-4">
                    <button class="btn btn-success waves-effect" type="button" id="vregbolpag_mensual_buscar">Buscar</button>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12" id="vregbolpag_mensual_result"></div>
            </div>
            <div class="row" id="vregbolpag_mensual_div_registrar" style="display:none;">
                <?php
echo $completar;
?>
            </div>
